                    ...
                    <tr key={lot.id} style={{ background:i%2===0?"transparent":"#1e1006", borderBottom:"1px solid #2a1808" }}>
                      ...
                      {activeTab==="rog" && (
                        <td style={{ padding:"8px 6px", textAlign:"center" }}>
                          <button onClick={()=>setRog(r=>({...r, a1: !r.a1?lot : r.a2===lot?r.a1 : r.a1===lot?null:r.a1, a2: !r.a1?r.a2 : r.a2===lot?null : r.a1===lot?r.a2 : !r.a2?lot:r.a2}))}
                            style={{ fontSize:10, padding:"2px 8px", borderRadius:4, cursor:"pointer", fontFamily:"inherit",
                              background: rog.a1===lot||rog.a2===lot ? "#6b4a1e" : "transparent",
                              border: `1px solid ${rog.a1===lot?"#e8c87a":rog.a2===lot?"#7aab6e":"#4a3018"}`,
                              color: rog.a1===lot?ACCENT:rog.a2===lot?"#7aab6e":"#a08060" }}>
                            {rog.a1===lot?"A":rog.a2===lot?"B":"pick"}
                          </button>
                        </td>
                      )}
                    </tr>
          ...
          return (
            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:18 }}>
              ...
              <div style={{ gridColumn:"1/-1", fontSize:11, color:"#4a3018", marginTop:4 }}>
                Tip: Switch to the Sale Lots tab with ROG Calculator open to pick lots from the table — they'll appear highlighted with A/B buttons.
              </div>
            </div>
          );
        })()}

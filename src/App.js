...
const ACCENT = "#e8c87a";
const SALE_COLORS = { "Feeder Cattle":"#c2763a", "Slaughter":"#c26070", "Bred Cows":"#7aab6e", "Fed Cattle":"#7b9fbf" };
const SALE_TYPES  = ["All", "Feeder Cattle", "Slaughter", "Bred Cows", "Fed Cattle"];
